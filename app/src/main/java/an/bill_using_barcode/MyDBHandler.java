...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABSE_NAME="customer_login.db";
    ...
    public static final String COLOUMN_FAMILY_SIZE="familysize";
...

    {
        ...
        values.put(COLOUMN_FAMILY_SIZE,b);
